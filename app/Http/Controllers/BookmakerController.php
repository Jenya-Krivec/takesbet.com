    ...
    */
    ...
    public function store(Request $request, string $key)
    {
        $request->validate([
            'name' => 'required',
            'logo_color' => 'required',
            'bonus_label_1_en' => 'required',
            'bonus_label_2_en' => 'required',
            'bonus_label_1_es' => 'required',
            'bonus_label_2_es' => 'required',
            'bonus_label_1_fr' => 'required',
            'bonus_label_2_fr' => 'required',
            'bonus_label_1_pt' => 'required',
            'bonus_label_2_pt' => 'required',
