...
@section('content')
    <main class="pt-20">
        ...
        <!--Reviews-->
        <form method="POST" action="{{route('admin.storeCasino', ['key' => $bookmaker['key']])}}" enctype="multipart/form-data" class="lg:px-56 sm:py-5 px-3 py-2 m-auto form">
            @csrf
        ...
        <div class="lg:px-56 sm:py-5 px-3 py-2 m-auto">
            <h3 class="text-lg sm:text-2xl font-bold px-0 sm:px-10 my-4">{{trans('casino_review.Promo Codes', ['bookmaker' => $bookmaker['name']])}}</h3>
            <div class="w-full flex justify-between p-5 flex-col sm:flex-row border-gray-200 border-2 rounded-xl shadow-gray-400 shadow-lg">
                <div class="flex-row justify-between items-center flex px-2">
                    ...
                    <div class="flex-row flex sm:hidden justify-end items-center">
                        <span data-url="{{$bookmaker['url']}}" class="text-white shadow-gray-400 bg-blue-700 text-xs sm:text-base rounded-full hover:bg-blue-600 flex justify-center items-center cursor-pointer transition-all duration-500 my-2 px-8 py-2">@lang('casino_review.Claim')</span>
                    </div>
                </div>
    ...
    <script defer type="text/javascript" src="{{ asset('js/casino/rate.js').'?v='.filemtime('js/casino/rate.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/textarea.js').'?v='.filemtime('js/admin/casino/textarea.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/delete.js').'?v='.filemtime('js/admin/casino/delete.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/language.js').'?v='.filemtime('js/admin/casino/language.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/caption.js').'?v='.filemtime('js/admin/casino/caption.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/subtitle.js').'?v='.filemtime('js/admin/casino/subtitle.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/paragraph.js').'?v='.filemtime('js/admin/casino/paragraph.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/picture.js').'?v='.filemtime('js/admin/casino/picture.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/list.js').'?v='.filemtime('js/admin/casino/list.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/prosCons.js').'?v='.filemtime('js/admin/casino/prosCons.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/sports.js').'?v='.filemtime('js/admin/casino/sports.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/payments.js').'?v='.filemtime('js/admin/casino/payments.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/support.js').'?v='.filemtime('js/admin/casino/support.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/comparison.js').'?v='.filemtime('js/admin/casino/comparison.js') }}"></script>
    <script defer type="text/javascript" src="{{ asset('js/admin/casino/addSection.js').'?v='.filemtime('js/admin/casino/addSection.js') }}"></script>
@endsection
