    ...
    public function run(): void
    {
        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => 'melbet',
             'bookmaker_id' => 2,
             'component' => 'p',
             'value_en' => '{"0":"Another interesting feature of this bookmaker is the ability to bet on an entire round of fixtures within a specific league as a single event. For example, you can predict the total number of goals in EPL matchweek 28 or compare the overall performance of home versus away teams. MELbet truly stands out for the depth and variety of its betting markets like no other."}',
             'value_es' => '{"0":"Otra característica interesante de esta casa de apuestas es la posibilidad de apostar en una jornada completa de una liga como si fuera un solo evento. Por ejemplo, puedes predecir el número total de goles en la jornada 28 de la Premier League o comparar el rendimiento global de los equipos locales frente a los visitantes. MELbet realmente destaca por la profundidad y variedad de sus mercados."}',
             'value_fr' => '{"0":"Un autre aspect intéressant de ce bookmaker est la possibilité de parier sur une journée complète d’un championnat comme un seul événement. Par exemple, vous pouvez prédire le nombre total de buts lors de la 28e journée de Premier League, ou comparer la performance globale des équipes à domicile et à l’extérieur. MELbet impressionne vraiment par la profondeur et la variété de ses marchés."}',
             'value_pt' => '{"0":"Outro diferencial interessante da casa é a possibilidade de apostar em uma rodada inteira de uma liga como um único evento. Por exemplo, você pode prever o total de gols da 28ª rodada da Premier League ou comparar o desempenho geral dos times mandantes contra os visitantes. A MELbet realmente se destaca pela profundidade e variedade dos seus mercados de apostas como nenhuma outra."}',
             'order' => 14,
            ]
        );
        Review::query()->updateOrCreate(
        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => 'melbet',
             'bookmaker_id' => 2,
             'component' => 'p',
             'value_en' => '{"0":"MELbet impresses with its market depth — some matches offer up to 300 different betting options. You can bet on over/under points, team totals, handicaps, quarter winners, winning margin, whether both teams will score more than 100 points, and much more."}',
             'value_es' => '{"0":"MELbet sorprende por la profundidad de su mercado: algunos partidos ofrecen hasta 300 opciones de apuesta diferentes. Puedes apostar al total de puntos (más/menos), total del equipo, hándicaps, ganador de cada cuarto, margen de victoria, si ambos equipos anotarán más de 100 puntos, entre muchas otras."}',
             'value_fr' => '{"0":"MELbet impressionne par la profondeur de ses marchés — certains matchs proposent jusqu\'à 300 options de pari différentes. Vous pouvez parier sur les totaux (plus/moins), les totaux d’équipe, les handicaps, les vainqueurs de quart-temps, l’écart final, si les deux équipes marqueront plus de 100 points, et bien d\'autres choses encore."}',
             'value_pt' => '{"0":"A MELbet impressiona pela profundidade dos seus mercados — algumas partidas oferecem até 300 opções de apostas diferentes. Você pode apostar em totais de pontos (mais/menos), totais da equipe, handicaps, vencedor de cada quarto, margem de vitória, se ambas as equipes marcarão mais de 100 pontos, entre outras possibilidades."}',
             'order' => 17,
            ]
        );
        Review::query()->updateOrCreate(
            ...
            ['key' => 'melbet',
             'bookmaker_id' => 2,
             'component' => 'p',
             'value_en' => '{"0":"Additionally, combined bets on several matches are available — essentially a teaser-style bet, but with a wider range of options."}',
             'value_es' => '{"0":"Además, se pueden hacer apuestas combinadas en varios partidos a la vez — básicamente una apuesta tipo teaser, pero con muchas más opciones."}',
             'value_fr' => '{"0":"De plus, il est possible de faire des paris combinés sur plusieurs matchs — un type de pari teaser, mais avec plus de flexibilité et de choix."}',
             'value_pt' => '{"0":"Além disso, estão disponíveis apostas combinadas em vários jogos ao mesmo tempo — essencialmente uma aposta do tipo teaser, mas com mais opções de personalização."}',
             'order' => 18,
            ]
        );
        Review::query()->updateOrCreate(
        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => 'melbet',
             'bookmaker_id' => 2,
             'component' => 'p',
                'value_en' => '{"0":"You can find more information about payment methods at the beginning of the review, in the «MELbet Quick Info»."}',
                'value_es' => '{"0":"Puedes encontrar más información sobre los métodos de pago al comienzo de la reseña, en la sección «Información rápida de MELbet»."}',
                'value_fr' => '{"0":"Vous pouvez trouver plus d’informations sur les méthodes de paiement au début de l’avis, dans la section « Infos rapides sur MELbet »."}',
                'value_pt' => '{"0":"Você pode encontrar mais informações sobre os métodos de pagamento no início da análise, na seção «Informações rápidas da MELbet»."}',
             'order' => 34,
            ]
        );
        Review::query()->updateOrCreate(
        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => 'melbet',
             'bookmaker_id' => 2,
             'component' => 'p',
             'value_en' => '{"0":"To complete this MELbet sports review, these are some common questions you’ve asked."}',
             'value_es' => '{"0":"Para concluir esta reseña de MELbet deportes, aquí tienes algunas preguntas frecuentes que nos han hecho."}',
             'value_fr' => '{"0":"Pour conclure cet avis sur les sports chez MELbet, voici quelques questions fréquentes que vous nous avez posées."}',
             'value_pt' => '{"0":"Para encerrar esta análise da MELbet esportiva, aqui estão algumas das perguntas mais frequentes que recebemos."}',
             'order' => 42
            ]
        );
        Review::query()->updateOrCreate(
