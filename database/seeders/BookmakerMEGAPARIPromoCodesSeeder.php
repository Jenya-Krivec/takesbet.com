    ...
    public function run(): void
    {
        ...
        PromoCode::query()->updateOrCreate(
            ...
            ['key' => 'megapari',
             'bookmaker_id' => 9,
             'component' => 'p',
             'value_en' => '{"0":"In addition, users have access to special bonuses for sports and casino games. Below, we’ll explain how to get the most out of them. All you need to do is register with the Megapari promo code :promocode."}',
             'value_es' => '{"0":"Además, los usuarios tienen acceso a bonos especiales para apuestas deportivas y juegos de casino. A continuación, te explicamos cómo aprovecharlos al máximo. Todo lo que necesitas hacer es registrarte con el código promocional de Megapari :promocode."}',
             'value_fr' => '{"0":"De plus, les utilisateurs ont accès à des bonus spéciaux pour les paris sportifs et les jeux de casino. Ci-dessous, nous vous expliquons comment en profiter au maximum. Tout ce que vous devez faire est de vous inscrire avec le code promotionnel de Megapari :promocode."}',
             'value_pt' => '{"0":"Além disso, os usuários têm acesso a bônus especiais para apostas esportivas e jogos de cassino. Abaixo, explicamos como aproveitá-los ao máximo. Tudo o que você precisa fazer é se registrar com o código promocional da Megapari :promocode."}',
             'order' => 2
            ]
        );
        PromoCode::query()->updateOrCreate(
