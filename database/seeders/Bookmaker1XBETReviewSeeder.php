        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => '1xbet',
             ...
             'value_en' => '{"0":"1XBET operates in over 100 countries worldwide and offers a comprehensive betting experience. This platform impresses with its scale — from a generous welcome bonus to a wide variety of sports and payment options.",
                             "1":"For more information on how to use the promo code NEWBONUS, check out the dedicated section. After registering, you’ll find a large selection of promotions, bonuses, and special offers.",
                             "2":"You can place both pre-match and live bets on over 30 sports, as well as on esports and non-sporting events such as politics, finance, and entertainment. In addition, 1XBET users can enjoy daily live streaming.",
                             "3":"The platform is available in multiple languages and supports a wide range of payment methods, including Bitcoin and various other cryptocurrencies."}',
             'value_es' => '{"0":"1XBET está disponible en más de 100 países y ofrece una experiencia de apuestas completa. Esta plataforma impresiona por su magnitud: desde un generoso bono de bienvenida hasta una amplia variedad de deportes y métodos de pago.",
                             "1":"Consulta la sección especial para obtener más información sobre cómo usar el código promocional NEWBONUS. Después de registrarte, tendrás acceso a una gran variedad de promociones, bonos y ofertas especiales",
                             "2":"Puedes realizar apuestas antes de los partidos y en vivo en más de 30 deportes, así como en eSports y eventos no deportivos como política, finanzas y entretenimiento. Además, los usuarios de 1XBET pueden disfrutar de transmisiones en vivo diarias.",
                             "3":"La plataforma está disponible en varios idiomas y admite numerosos métodos de pago, incluyendo Bitcoin y otras criptomonedas."}',
             'value_fr' => '{"0":"1XBET est présent dans plus de 100 pays à travers le monde et propose une expérience de pari complète. La plateforme impressionne par son ampleur — du bonus de bienvenue généreux à la grande variété de sports et de moyens de paiement.",
                             "1":"Pour en savoir plus sur l\'utilisation du code promo NEWBONUS, consultez la section dédiée. Une fois inscrit, vous aurez accès à de nombreuses promotions, bonus et offres spéciales.",
                             "2":"Vous pouvez placer des paris avant les matchs et en direct sur plus de 30 sports, ainsi que sur les eSports et d\'autres événements non sportifs comme la politique, la finance et les divertissements. De plus, les utilisateurs de 1XBET peuvent profiter de diffusions en direct quotidiennes.",
                             "3":"La plateforme est disponible en plusieurs langues et prend en charge une large gamme de méthodes de paiement, y compris le Bitcoin et d\'autres cryptomonnaies."}',
             'value_pt' => '{"0":"A 1XBET está presente em mais de 100 países e oferece uma experiência de apostas completa. Esta plataforma impressiona pela sua dimensão — desde um generoso bónus de boas-vindas até à grande variedade de desportos e métodos de pagamento.",
                             "1":"Consulte a secção dedicada para saber mais sobre como utilizar o código promocional NEWBONUS. Após o registo, encontrará uma vasta seleção de promoções, bónus e ofertas especiais.",
                             "2":"Pode fazer apostas pré-jogo e ao vivo em mais de 30 modalidades, assim como em eSports e eventos não desportivos como política, finanças e entretenimento. Além disso, os utilizadores da 1XBET podem usufruir de transmissões em direto diárias.",
                             "3":"A plataforma está disponível em vários idiomas e suporta uma ampla gama de métodos de pagamento, incluindo Bitcoin e outras criptomoedas."}',
             'order' => 6,
            ]
        );
        Review::query()->updateOrCreate(
        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => '1xbet',
             ...
             'value_en' => '{"0":"After football, the most popular sports on 1XBET are tennis, basketball, and ice hockey — all of which can be found at the top of the sports category list.",
                             "1":"Tennis covers ATP, WTA, ITF, and Challenger tournaments, with betting options available for both men\'s and women\'s singles and doubles matches. Major matches offer up to 50 betting markets, ensuring a solid depth of options.",
                             "2":"The basketball section features numerous leagues from around the world — from NCAA college games to European championships. The NBA offers the greatest variety, with approximately 200 markets per game, including overtime bets.",
                             "3":"In ice hockey, the NHL provides the widest range of betting options — around 1000 markets per game. However, the Swedish and Finnish leagues are also worth exploring, with over 600 markets available per match.",
                             "4":"We compared some of 1XBET\'s odds with those from leading bookmakers and, as shown in the table below, 1XBET offers quite competitive odds. Still, keep in mind these are just random examples, so always double-check before placing your bets."}',
             'value_es' => '{"0":"Después del fútbol, los deportes más populares en 1XBET son el tenis, el baloncesto y el hockey sobre hielo, todos disponibles al comienzo de la lista de categorías deportivas.",
                             "1":"El tenis incluye torneos ATP, WTA, ITF y Challenger, con opciones de apuestas para partidos individuales y dobles, tanto masculinos como femeninos. Los encuentros más importantes ofrecen hasta 50 mercados de apuestas, lo que garantiza una buena profundidad.",
                             "2":"La sección de baloncesto cubre numerosas ligas de todo el mundo, desde partidos universitarios de la NCAA hasta campeonatos europeos. La NBA ofrece la mayor variedad, con unos 200 mercados por partido, incluyendo apuestas para la prórroga.",
                             "3":"En el hockey, la NHL cuenta con la oferta más amplia de mercados — alrededor de 1000 por partido. Sin embargo, también vale la pena revisar las ligas sueca y finlandesa, que ofrecen más de 600 mercados por encuentro.",
                             "4":"Comparamos algunas cuotas de 1XBET con las de los principales operadores, y como muestra la tabla a continuación, las cuotas de 1XBET son bastante atractivas. No obstante, recuerda que estos son solo ejemplos aleatorios, así que siempre investiga antes de apostar."}',
             'value_fr' => '{"0":"Après le football, les sports les plus populaires sur 1XBET sont le tennis, le basketball et le hockey sur glace — tous disponibles en haut du menu des catégories sportives.",
                             "1":"Le tennis comprend les tournois ATP, WTA, ITF et Challenger, avec des options de paris sur les matchs simples et doubles, hommes et femmes. Les matchs majeurs proposent jusqu’à 50 marchés de paris, offrant ainsi une bonne profondeur.",
                             "2":"La section basketball couvre de nombreuses ligues à travers le monde — des matchs universitaires de la NCAA aux championnats européens. La NBA propose la plus grande variété, avec environ 200 marchés par match, y compris les prolongations.",
                             "3":"En hockey, la NHL offre le plus grand choix, avec environ 1000 marchés par match. Les ligues suédoise et finlandaise valent également le détour, avec plus de 600 marchés disponibles par rencontre.",
                             "4":"Nous avons comparé certaines cotes de 1XBET avec celles de grands bookmakers. Comme le montre le tableau ci-dessous, les cotes de 1XBET sont assez compétitives. Néanmoins, ce ne sont que des exemples aléatoires, alors vérifiez toujours les informations avant de parier."}',
             'value_pt' => '{"0":"Após o futebol, os desportos mais populares na 1XBET são o ténis, o basquetebol e o hóquei no gelo — todos visíveis no topo da lista de categorias desportivas.",
                             "1":"O ténis inclui torneios ATP, WTA, ITF e Challenger, com apostas disponíveis para jogos de singulares e pares, tanto masculinos como femininos. Os grandes jogos oferecem até 50 mercados de apostas, garantindo uma boa profundidade.",
                             "2":"A secção de basquetebol abrange várias ligas de todo o mundo — desde os jogos universitários da NCAA até aos campeonatos europeus. A NBA tem a maior variedade, com cerca de 200 mercados por jogo, incluindo apostas para prolongamento.",
                             "3":"No hóquei no gelo, a NHL oferece a maior gama de apostas — cerca de 1000 mercados por jogo. No entanto, também vale a pena conferir as ligas sueca e finlandesa, com mais de 600 mercados por partida.",
                             "4":"Comparamos algumas odds da 1XBET com as de grandes casas de apostas e, como mostra a tabela abaixo, as odds da 1XBET são bastante competitivas. No entanto, estes são apenas exemplos aleatórios — faça sempre a sua própria pesquisa antes de apostar."}',
             'order' => 13,
            ]
        );
        Review::query()->updateOrCreate(
        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => '1xbet',
             ...
             'value_en' => '{"0":"1XBET offers an exceptionally wide range of live betting options — from traditional football, basketball, tennis, and ice hockey matches to a vast selection of e-sports events. Among them are not only well-known games like Rocket League, Counter Strike, Call of Duty, and StarCraft, but also popular titles such as FIFA, Mortal Kombat, Tekken, Quake 4, and Street Fighter. In addition, the platform allows you to place bets on virtual versions of traditional sports — e-rugby, e-football, e-golf, e-baseball, and more.",
                             "1":"The depth of markets in live mode is impressive: top matches offer over 200 betting options. 1XBET also supports live streaming — you can identify broadcasted events by the “live” TV icon next to the team names."}',
             'value_es' => '{"0":"1XBET ofrece una gama excepcionalmente amplia de apuestas en vivo, que incluye desde partidos tradicionales de fútbol, baloncesto, tenis y hockey sobre hielo hasta una gran variedad de eventos de e-sports. Entre ellos se encuentran juegos tan conocidos como Rocket League, Counter Strike, Call of Duty y StarCraft, así como títulos populares como FIFA, Mortal Kombat, Tekken, Quake 4 y Street Fighter. Además, la plataforma permite apostar en versiones virtuales de deportes tradicionales — como e-rugby, e-fútbol, e-golf, e-béisbol y más.",
                             "1":"La profundidad de los mercados en modo en vivo es impresionante: los partidos más importantes ofrecen más de 200 opciones de apuesta. 1XBET también permite transmisiones en directo — los eventos con streaming se identifican con el ícono de “live” en forma de televisor junto al nombre de los equipos."}',
             'value_fr' => '{"0":"1XBET propose une gamme extrêmement large de paris en direct — des matchs classiques de football, de basketball, de tennis et de hockey sur glace à une grande variété d’événements e-sport. Cela inclut non seulement des jeux bien connus comme Rocket League, Counter Strike, Call of Duty et StarCraft, mais aussi des titres populaires tels que FIFA, Mortal Kombat, Tekken, Quake 4 et Street Fighter. La plateforme permet également de parier sur des versions virtuelles de sports traditionnels — comme le e-rugby, le e-football, le e-golf, le e-baseball, entre autres.",
                             "1":"La profondeur des marchés en direct est impressionnante : les plus grands matchs offrent plus de 200 options de paris. 1XBET propose aussi des retransmissions en direct — repérez les événements diffusés grâce à l’icône “live” en forme de téléviseur à côté du nom des équipes."}',
             'value_pt' => '{"0":"A 1XBET oferece uma gama incrivelmente ampla de apostas ao vivo — desde partidas tradicionais de futebol, basquete, tênis e hóquei no gelo até uma enorme variedade de eventos de e-sports. Entre eles estão não apenas jogos conhecidos como Rocket League, Counter Strike, Call of Duty e StarCraft, mas também títulos populares como FIFA, Mortal Kombat, Tekken, Quake 4 e Street Fighter. A plataforma também permite apostas em versões virtuais de esportes tradicionais — como e-rúgbi, e-futebol, e-golfe, e-beisebol e muito mais.",
                             "1":"A profundidade dos mercados ao vivo é impressionante: partidas importantes contam com mais de 200 opções de apostas. A 1XBET também oferece transmissão ao vivo — os jogos com streaming são indicados por um ícone de TV “live” ao lado do nome das equipes."}',
             'order' => 22,
            ]
        );
        Review::query()->updateOrCreate(
        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => '1xbet',
             ...
             'value_en' => '{"0":"It\'s hard not to notice: the 1XBET homepage looks cluttered. Menus are everywhere, and hundreds of live odds appear as soon as you scroll down. At first glance, it’s difficult to navigate and locate the main sports sections.",
                             "1":"To get there, you’ll need to scroll past countless live betting options. Clicking on your desired sport in the horizontal menu should bring up a list of countries, but instead, you\'re shown a long list of leagues and tournaments — which isn’t very user-friendly. After selecting a league, the matches will appear in the main area of the screen. From there, you can choose one of the main markets or click on the team names to view the full list of betting options. If you find a bet that interests you, just click on the odds and it will be added to your bet slip on the right-hand sidebar.",
                             "2":"There really is a lot happening on 1XBET — you’ll see for yourself. Below are just a few of the features and tools that stood out to us:"}',
        ...
        Review::query()->updateOrCreate(
            ...
            ['key' => '1xbet',
             ...
             'value_es' => '{"0":"Hay una gran variedad de métodos de pago en 1XBET. Aquí están solo algunos de los principales métodos.",
                             "1":"Puedes encontrar más información sobre los métodos de pago al comienzo de la reseña, en la sección «Información rápida de 1XBET»."}',
             'value_fr' => '{"0":"Il y a une grande sélection de méthodes de paiement sur 1XBET. Voici quelques-unes des principales méthodes.",
                             "1":"Vous pouvez trouver plus d’informations sur les méthodes de paiement au début de l’avis, dans la section « Infos rapides sur 1XBET »."}',
             'value_pt' => '{"0":"Há uma enorme seleção de métodos de pagamento na 1XBET. Aqui estão apenas alguns dos principais métodos.",
                             "1":"Você pode encontrar mais informações sobre os métodos de pagamento no início da análise, na seção «Informações rápidas da 1XBET»."}',
             'order' => 38,
            ]
        );
        Review::query()->updateOrCreate(
