    ...
    public function run(): void
    {
        PromoCode::query()->updateOrCreate(
            ...
            ['key' => '888starz',
             'bookmaker_id' => 8,
             'component' => 'p',
             'value_en' => '{"0":"888starz Casino is quickly gaining popularity among gambling enthusiasts. The platform offers a huge selection of casino games, a wide variety of sports betting options, and some of the most generous bonuses out there. This includes a welcome bonus and other great promotions for new users. In this review, we’ll tell you more about the special offers and share an exclusive 888starz promo code for your first deposit. Don’t miss out!"}',
             'value_es' => '{"0":"El casino 888starz está ganando rápidamente popularidad entre los aficionados a los juegos de azar. La plataforma ofrece una enorme selección de juegos de casino, una gran variedad de apuestas deportivas y algunos de los bonos más generosos del mercado. Entre ellos se incluye un bono de bienvenida y otras promociones atractivas para nuevos usuarios. En esta reseña, te contaremos más sobre las ofertas especiales y compartiremos un código promocional de 888starz para tu primer depósito. ¡No te lo pierdas!"}',
             'value_fr' => '{"0":"Le casino 888starz gagne rapidement en popularité auprès des amateurs de jeux d\'argent. La plateforme propose un vaste choix de jeux de casino, une grande variété de paris sportifs, et certains des bonus les plus généreux du marché. Cela inclut un bonus de bienvenue et d\'autres promotions avantageuses pour les nouveaux utilisateurs. Dans cet avis, nous vous parlerons davantage des offres spéciales et partagerons un code promotionnel de 888starz pour votre premier dépôt. Ne le manquez pas !"}',
             'value_pt' => '{"0":"O cassino 888starz está rapidamente ganhando popularidade entre os fãs de jogos de azar. A plataforma oferece uma enorme variedade de jogos de cassino, diversas opções de apostas esportivas e alguns dos bônus mais generosos do mercado. Isso inclui um bônus de boas-vindas e outras promoções vantajosas para novos usuários. Nesta análise, contaremos mais sobre as ofertas especiais e compartilharemos um código promocional da 888starz para o seu primeiro depósito. Não perca!"}',
             'order' => 1
            ]
        );
        PromoCode::query()->updateOrCreate(
        ...
        PromoCode::query()->updateOrCreate(
            ...
            ['key' => '888starz',
             'bookmaker_id' => 8,
             'component' => 'p',
             'value_en' => '{"0":"This 888starz promo code will help you increase your winnings and make the gameplay even more exciting. Don’t miss your chance — use it when creating a new account."}',
             'value_es' => '{"0":"Este código promocional de 888starz te ayudará a aumentar tus ganancias y hacer que el juego sea aún más emocionante. No pierdas la oportunidad: úsalo al crear tu nueva cuenta."}',
             'value_fr' => '{"0":"Ce code promotionnel de 888starz vous aidera à augmenter vos gains et à rendre le jeu encore plus excitant. Ne ratez pas cette chance — utilisez-le lors de la création de votre nouveau compte."}',
             'value_pt' => '{"0":"Este código promocional da 888starz ajudará você a aumentar seus ganhos e tornar o jogo ainda mais emocionante. Não perca essa oportunidade — use-o ao criar sua nova conta."}',
             'order' => 3
            ]
        );
        PromoCode::query()->updateOrCreate(
        ...
        PromoCode::query()->updateOrCreate(
            ...
            ['key' => '888starz',
             'bookmaker_id' => 8,
             'component' => 'p',
             'value_en' => '{"0":"By using the 888starz promo code :promocode, you will have the opportunity to activate an impressive welcome bonus of up to 1500 EUR as a gift on your first deposit."}',
             'value_es' => '{"0":"Al usar el código promocional de 888starz :promocode, tendrás la oportunidad de activar un impresionante bono de bienvenida de hasta 1500 EUR como regalo en tu primer depósito."}',
             'value_fr' => '{"0":"En utilisant le code promotionnel de 888starz :promocode, vous aurez la possibilité d’activer un impressionnant bonus de bienvenue allant jusqu’à 1500 EUR en cadeau sur votre premier dépôt."}',
             'value_pt' => '{"0":"Ao usar o código promocional da 888starz :promocode, você terá a oportunidade de ativar um impressionante bônus de boas-vindas de até 1500 EUR como presente no seu primeiro depósito."}',
             'order' => 6
            ]
        );
        PromoCode::query()->updateOrCreate(
